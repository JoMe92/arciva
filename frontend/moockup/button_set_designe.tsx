...
const ICONS: Record<string, React.ReactNode> = {
      ...
      path={
        <>
          ...
          <path
            ...
            strokeLinecap="round"
          />
          <rect x="4" y="4" width="16" height="6" rx="2" stroke="currentColor" strokeWidth="1.6" />
        </>
      }
    />
  ),
      ...
      path={
        <>
          <path
            ...
            strokeWidth="1.6"
          />
          <path d="M8 7V5h8v4" stroke="currentColor" strokeWidth="1.6" />
          <path d="M8 12h8v8H8z" stroke="currentColor" strokeWidth="1.2" />
        </>
      }
    />
  ),
  ...
  restore: (
    <Svg
      path={
        <>
          <path d="M6 9v4H2" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
          <path d="M4 13a8 8 0 1 0 3-6.2" stroke="currentColor" strokeWidth="1.6" fill="none" />
          <path d="M12 8v4l3 1.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
        </>
      }
    />
  ),
