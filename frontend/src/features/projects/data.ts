...
export const U = {
  ...
  glacier:
    'https://images.unsplash.com/photo-1500043357865-c6b8827edf3a?auto=format&fit=crop&w=1600&q=80',
  trail:
    'https://images.unsplash.com/photo-1501706362039-c06b2d715385?auto=format&fit=crop&w=1600&q=80',
...
export const PROJECTS: Project[] = [
  {
    ...
    aspect: 'portrait',
    image: U.bike,
    previewImages: [{ url: U.bike, order: 0 }],
    tags: ['gravel', 'outdoor'],
    source: 'static',
  },
  {
    id: 'p2',
    title: 'Polo Country',
    client: 'Element × Ralph Lauren',
    aspect: 'portrait',
    image: U.knit,
    previewImages: [{ url: U.knit, order: 0 }],
  ...
  },
  {
    ...
    aspect: 'portrait',
    image: U.portrait,
    previewImages: [{ url: U.portrait, order: 0 }],
    tags: ['portrait'],
    source: 'static',
  },
  {
    id: 'p4',
    title: 'Mayer of Munich',
    client: 'Monocle',
    aspect: 'portrait',
    image: U.felt,
    previewImages: [{ url: U.felt, order: 0 }],
    tags: ['reportage', 'color'],
    source: 'static',
  },
  {
    id: 'p5',
  ...
  },
  {
    ...
    aspect: 'landscape',
    image: U.trail,
    previewImages: [{ url: U.trail, order: 0 }],
    tags: ['brand', 'outdoor'],
    source: 'static',
  },
  {
    ...
    aspect: 'square',
    image: U.stone,
    previewImages: [{ url: U.stone, order: 0 }],
    tags: ['identity'],
    source: 'static',
  },
  {
    ...
    aspect: 'portrait',
    image: U.studio,
    previewImages: [{ url: U.studio, order: 0 }],
    tags: ['studio'],
    source: 'static',
  },
  {
    ...
    aspect: 'landscape',
    image: U.city,
    previewImages: [{ url: U.city, order: 0 }],
    tags: ['architecture'],
    source: 'static',
  },
]
