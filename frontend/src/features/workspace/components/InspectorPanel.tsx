...
import { ChevronRightIcon, InfoIcon, CheckIcon, CameraIcon, CalendarClockIcon, SettingsIcon, MinusIcon, PlusIcon, FrameIcon, PreviewIcon, FolderIcon, ChevronLeftIcon, InspectorIcon } from './icons'
...
function MetadataSourceRow({
    ...
    return (
        <button
            ...
            className={`flex w-full items-center gap-3 rounded-[12px] border px-3 py-2.5 text-left transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--focus-ring,#1A73E8)] ${selected ? 'border-[var(--river-400,#69A3AE)] bg-[var(--river-50,#F0F7F6)]' : 'border-[var(--border,#EDE1C6)] bg-[var(--surface,#FFFFFF)] hover:border-[var(--text,#1F1E1B)]'
